...
#        account for 86 million neurons present within brain
...
class MultipolarNeuron(Neuron):
    ...
    def __init__(self, neuron_type="pyramidal"):
        ...
        # Inherited describe method from parent 
        super().describe()
